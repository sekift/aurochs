...
public class JedisCloseUtil {
	 ...
	 * @param r
	 */
	public static void returnBrokenResourceSilently(JedisSentinelPool jp, Jedis r) {
		if (null != jp && null != r) {
			try {
	 ...
	 * @param r
	 */
	public static void returnResourceSilently(JedisSentinelPool jp, Jedis r) {
		if (null != jp && null != r) {
			try {
